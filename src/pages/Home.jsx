...
export default function Home() {
  return (
    <section className="max-w-7xl mx-auto font-custom text-gray-800 glossy-container">
      {/* Hero Section */}
      <div className="relative isolate overflow-hidden bg-gray-900 rounded-xl glossy-card">
        <img
      ...
      <section className="bg-gradient-to-b from-blue-50 via-white to-blue-100 py-12 px-6 rounded-3xl shadow-inner max-w-6xl mx-auto my-12 glossy-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Promotion 1 */}
          <div
            className="bg-white border border-gray-200 rounded-xl p-6 glossy-card shadow-md hover:shadow-lg transition"
            data-aos="fade-up"
          >
            ...
            <p className="text-gray-600 mb-4">
              Purchase a book now through August 31, 2025 and receive free
              shipping!
            </p>
            <a
              href="/book"
