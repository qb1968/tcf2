      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
        ...
        <div className="w-full md:w-2/3">
          ...
          <p className="text-gray-700 leading-relaxed mb-5">
            ...
            Dad&#39;s simple journey handling tragedy as his Father built a Godly
            Legacy, along with the learning opportunities from Terry&#39;s
            unique life experiences and failures. These experiences are woven through common sense
            ideas built on the foundation of authentic Prayer, Scripture, Traits
            of Jesus, Bible Studies and Christian Music.{" "}
          </p>
          <p className="text-gray-700 leading-relaxed mb-5">
